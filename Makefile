...
libpspusbinclude_HEADERS 	= pspusb.h pspusbbus.h pspusbcam.h pspusbacc.h pspusbmic.h pspusbcm.h
lib_LIBRARIES 				= libpspusb.a libpspusb_driver.a libpspusbbus_driver.a libpspusbcam.a libpspusbmic.a
...
all: $(USB_OBJS) $(USBDRIVER_OBJS) $(USBBUSDRIVER_OBJS) $(USBCAM_OBJS) $(USBMIC_OBJS) $(lib_LIBRARIES)
...
$(lib_LIBRARIES):
	ar -rcs libpspusb.a $(USB_OBJS)
	ar -rcs libpspusb_driver.a $(USBDRIVER_OBJS)
	ar -rcs libpspusbbus_driver.a $(USBBUSDRIVER_OBJS)
	ar -rcs libpspusbcam.a $(USBCAM_OBJS)
	ar -rcs libpspusbmic.a $(USBMIC_OBJS)
