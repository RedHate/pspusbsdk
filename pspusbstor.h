...
/**
  ...
  * @return 0 on success
  */
int sceUsbstorBootRegisterNotify(unsigned int eventFlag);
...
/**
  ...
  * @return 0 on success
  */
int sceUsbstorBootUnregisterNotify(unsigned int eventFlag);
...
/**
  ...
  * @return 0 on success
  */
int sceUsbstorBootSetCapacity(unsigned int size);

// the following are disabled until more testing is done
#if 0
int sceUsbstorBootGetDataSize(void); // what for ?
int sceUsbstorBootSetLoadAddr(unsigned int addr); // ?
int sceUsbstorBootSetStatus(int status); // 1=?
